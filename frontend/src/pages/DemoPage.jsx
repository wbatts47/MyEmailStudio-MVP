...
const EmailPreviewFull = () => (
  <div style={{ fontFamily: "Arial, sans-serif", fontSize: "14px" }}>
    <div style={{ background: "#1a3a2a", padding: "32px 40px", textAlign: "center" }}>
      <p style={{ color: "#F5D000", fontSize: "10px", letterSpacing: "3px", textTransform: "uppercase", margin: "0 0 6px" }}>GreenLeaf Landscaping</p>
      <h1 style={{ color: "#fff", fontSize: "26px", margin: 0, fontWeight: 700, fontFamily: "Georgia, serif" }}>Summer Special</h1>
      <p style={{ color: "#a0c4a0", fontSize: "12px", margin: "6px 0 0" }}>Limited Time Offer — This Week Only</p>
    </div>
    <div style={{ padding: "36px 40px", background: "#fff" }}>
      <p style={{ color: "#333", margin: "0 0 14px" }}>Hi Sarah,</p>
      <h2 style={{ color: "#1a3a2a", fontSize: "20px", margin: "0 0 14px", fontWeight: 700, lineHeight: 1.3 }}>
        Your lawn deserves the best — and this week, it costs 20% less.
      </h2>
      <p style={{ color: "#555", lineHeight: 1.7, margin: "0 0 22px", fontSize: "15px" }}>
        Summer is here, and your lawn is the first thing people notice. Whether you need a full overhaul 
        or just weekly maintenance, our team is ready to make your yard look incredible.
      </p>
      <div style={{ background: "#f0f7f0", borderLeft: "4px solid #4CAF50", padding: "14px 18px", margin: "0 0 24px", borderRadius: "0 8px 8px 0" }}>
        <p style={{ color: "#2a5c2a", fontSize: "14px", margin: 0, fontWeight: 600 }}>✓ 20% off all lawn care services booked this week</p>
        <p style={{ color: "#2a5c2a", fontSize: "14px", margin: "7px 0 0", fontWeight: 600 }}>✓ Free lawn assessment with every booking</p>
        <p style={{ color: "#2a5c2a", fontSize: "14px", margin: "7px 0 0", fontWeight: 600 }}>✓ Same-week scheduling available</p>
      </div>
      <div style={{ textAlign: "center", margin: "32px 0 14px" }}>
        <a href="#" style={{ background: "#4CAF50", color: "#fff", padding: "16px 40px", borderRadius: "50px", textDecoration: "none", fontSize: "17px", fontWeight: 700, display: "inline-block" }}>
          Book My Service — Save 20%
        </a>
        <p style={{ color: "#888", fontSize: "12px", margin: "12px 0 0" }}>Offer expires Sunday, June 30 · Valid for all lawn care services</p>
      </div>
    </div>
    <div style={{ background: "#f8f8f8", padding: "20px 40px", borderTop: "1px solid #eee", textAlign: "center" }}>
      <p style={{ color: "#999", fontSize: "12px", margin: 0 }}>
        GreenLeaf Landscaping · 1234 Garden Way, Austin, TX 78701<br/>
        <a href="#" style={{ color: "#4CAF50" }}>Unsubscribe</a> · <a href="#" style={{ color: "#4CAF50" }}>View in browser</a>
      </p>
    </div>
  </div>
);
...
export default function DemoPage() {
  ...
  const [customBrief, setCustomBrief] = useState(SAMPLE_BRIEFS[0].text);
